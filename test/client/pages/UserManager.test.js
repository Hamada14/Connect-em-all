...
describe("Settings Page UI", () => {
  ...
  describe('Form Labels', () => {
    ...
    it('Form labels have the correct text', () => {
      const expectedLabels = ['Old Password', 'New Password', 'Confirm Password', 'Full Name', 'Birthday'];
  ...
  describe('Form Inputs', () => {
    ...
    it('Form inputs have the correct placeholder', () => {
      const expectedPlaceholders = ['Old Password', 'New Password', 'Confirm Password',
...
describe("Settings Page Logic", () => {
  ...
  describe('On Clicking Submit', () => {
    ...
    it('sends a request to /api/update_info', () => {
      expect(callParams[0]).toEqual('/api/update_info');
    });
  ...
  describe('On Successful Settings Update', () => {
    ...
    it('Sends a request to /api/update_info on Clicking submit', () => {
      submitGenericInputs(wrapper);
  ...
  describe('On Failed Settings Update', () => {
